            ...
            try {
                ...
                if (selectedProfile?.preferences) {
                    ...
                    const uniqueRecentItems = recent
                        .reverse()
                        .filter((item, index, self) => self.findIndex((i) => i.url === item.url) === index && item.mainMenu === 'stocks')
                        .slice(0, 3)
                        .map((item) => ({
                            text: item.label,
                            subtext: item.name,
            ...
            <div className="p-2 md:p-4">
                ...
                <div className="mb-2 flex justify-content-between align-items-center">
                    <div className="mb-4 flex justify-content-between align-items-center">
                        <span className="text-900 font-medium text-3xl m-0.5">Inventory Management {showDash ? ' Dashboard' : ''}</span>
                    </div>
                    <div className="mb-4 flex justify-content-between align-items-center">
                ...
                >
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-4">
                            <TotalComponent TotalComp={'Total Samples'} isEdit={isEdit} total={totalCompanies} />
                        </div>
                    </div>
                </div>
