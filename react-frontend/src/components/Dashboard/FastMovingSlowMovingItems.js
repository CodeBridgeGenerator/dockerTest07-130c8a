    ...
    useEffect(() => {
        ...
        const fetchFastSlowMovingItems = async () => {
            try {
                ...
                const sortedItems = Object.keys(itemMovements).sort((a, b) => itemMovements[b] - itemMovements[a]);
    ...
    return (
        <div className="surface-card shadow-2 border-round p-3">
            <div className="flex align-items-center">
                ...
                >
                    <span className="block text-900 font-medium mb-1">Fast-Moving vs Slow-Moving Items</span>
                </div>
            </div>
            {loading ? (
